...
function dailyMeal(){
    sapaDey = "True"
    while(sapaDey == True){
        console.log("custard in the morning");
        console.log("I must eat garri in the afternoon");
        console.log("I must eat indomie in the night");
    }
}
function submitted(){
    alert("Thank you for subscribing to our page");
}